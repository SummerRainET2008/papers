...
\hline
LEAM & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{-} & \multirow{2}*{$0.4545$} & \multirow{2}*{$0.5554$} & \multirow{2}*{$0.5936$} & \multirow{2}*{$0.6599$} & \multirow{2}*{$0.7086$} & \multirow{2}*{$0.6091$}\tabularnewline
(classification) & & & & & & & & & & & & &\tabularnewline
\hline
...
\cline{2-7}
\multicolumn{1}{|c|}{} & Hierarchical SFC & $0.7334$ & $0.7445$ & $0.7516$ & - & -\tabularnewline
\hline
\end{tabular}
\par\end{centering}
