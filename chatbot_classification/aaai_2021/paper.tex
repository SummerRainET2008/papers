...
\begin{document}
  ...
  {todo: Add joint NER and classification problem here.}
  ...
  \begin{table*}
    \begin{centering}
      ...
      \begin{tabular}{|c|c|c|c|c|c|}
        \hline 
        \textbf{Dataset} & \textbf{Domain} & \textbf{\#Class} & \textbf{\#Samples} & \textbf{\#Samples/Class} & \textbf{Experimental Settings}\tabularnewline
        \hline 
  ...
  classification  with  very  limited  semantics labels and several sentences as
  ...
  queries,  and  each  query  is  usually  one  sentence. Table \ref{tbe:dataset
    ...
    \begin{centering}
      \scalebox{0.55}{
        \begin{tabular}{|c|cccccc|cccccc|cccccc|c|c|}
          ...
          \cline{2-21}
          \multicolumn{1}{|c|}{} & $\textbf{5}$ & $\textbf{10}$ & $\textbf{15}$ & $\textbf{20}$ & $\textbf{30}$ & $\textbf{50}$ & $\textbf{5}$ & $\textbf{10}$ & $\textbf{15}$ & $\textbf{20}$ & $\textbf{30}$ & $\textbf{50}$ & $\textbf{5}$ & $\textbf{10}$ & $\textbf{15}$ & $\textbf{20}$ & $\textbf{30}$ & $\textbf{50}$ & \textbf{Full} & \textbf{Full}\tabularnewline
          \hline
          ...
          (classification) & & & & & & & & & & & & & & & & & & & &\tabularnewline
          RoBERTa-large & \multirow{2}*{$0.8974$} & \multirow{2}*{$0.9372$} & \multirow{2}*{$0.9508$} & \multirow{2}*{$0.9584$} & \multirow{2}*{$0.9621$} & \multirow{2}*{$0.9733$} & \multirow{2}*{$0.7690$} & \multirow{2}*{$0.8728$} & \multirow{2}*{$0.8966$} & \multirow{2}*{$0.9099$} & \multirow{2}*{$0.9227$} & \multirow{2}*{$0.9313$} & \multirow{2}*{$0.6044$} & \multirow{2}*{$0.7002$} & \multirow{2}*{$0.7129$} & \multirow{2}*{$0.7436$} & \multirow{2}*{$0.7493$} & \multirow{2}*{$0.7678$} & \multirow{2}*{$0.7990$} & \multirow{2}*{$0.7156$}\tabularnewline
          (classification) & & & & & & & & & & & & & & & & & & & &\tabularnewline
  ...
  \begin{enumerate}
    ...
    consists  of  a popular CNN based TextCNN \cite{kim2014convolutional}, and a
    recently  proposed label-embedding based LEAM (todo: reference and its label
    setting). Empircally,
  ...
  validation  set based on testing result in weighted F-score (todo: reference). 
  We report the F-score as the main evaluation measure for all experiments.
  ...
  Table  \ref{tbe:table2} presents all results on the five datasets model set-up
  in  detail.  The performance of each model is measured in F-score on the fixed
  test  set  for  each  dataset.  Overall,  two-stage  SFC systems show moderate
  improvements  over  all  baseline systems. This observation gives us a general
  idea  that  classification  model  and  similarity  model can actually provide
  complementary  information  to  each  other,  and  combining them together can
  enhance the overall capability based on richer extracted semantic information.
  Furthermore, we also studied the performance among all the variants of SFCs on
  different data settings to explore the benefits brought by multi-task training
  and the joint-model structure.

  \subsubsection*{Which SFC variant performs best?} 
  ...
  1,  corresponding  to  sentence pair similarity model, degrades by 0.8 percent
  point  on average, and training with only task 2, corresponding to top-K based
  ...
  system  performance.  Besides, task 2 play a relatively more important role in
  multi-task learning, and this aligns with their optimal weight settings.

  Joint SFC consistently outperforms two-stage SFC on 5 diverse datasets by 0.95
  percents  on  average. This observation supports the idea that the joint model
  ...
  \subsubsection*{Is  the  fusion of a classification model and similarity model
  ...
  percent points, RoBERTa-large by 2.04 percents on average F-score over 5 datasets.  
  ...
  \subsubsection*{How does joint SFC interact with the classfication in stage
  1?}
  {todo: content}

  \subsubsection*{How does SFC perform with different  training  data  size} 
  We analyze the
  ...
  RoBERTa-large  classification  model.  Moreover,  the  improvement  in F-score
  ...
  \subsubsection*{How is joint SFC related to the label  embedding based  LEAM?}
  ...
  two-stage  SFC  by  0.41  percents  in  overall  average  F-score  on  ITG and
