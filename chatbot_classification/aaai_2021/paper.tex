...
\begin{figure}[htbp]
\centering 
\subfigure[text classification model structure based on pre-trained transformer]{
\label{Fig.1.sub.1}
\includegraphics[scale=0.6]{picture1.pdf}}
\subfigure[sentence-pair model structure based on cross-attention mechanism]{
\label{Fig.1.sub.2}
\includegraphics[scale=0.55]{picture2.pdf}}
\caption{Model Structure of 2 popular approach for building task-specific conversational chatbot}
\label{Fig.1.main}
\end{figure}
