\begin{abstract}
  ...
  which combines both the performance of a classification model and the ability of supporting out-of-domain data from a similarity model
  in the framework of multi-task  training. We conduct extensive
